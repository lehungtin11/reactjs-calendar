...
const EventForm = ({ eventDetails, onSave, onCancel }) => {
  ...
  const [event, setEvent] = useState({
    ...
    color:
      eventDetails?.color ||
      (eventDetails.type == "appointment" ? "#FFE4C8" : "#F9BE81"), // Default color blue
  });
  ...
  useEffect(() => {
    if (eventDetails) {
      setEvent({
        ...
        start: isValidDate(new Date(eventDetails.start))
          ? new Date(eventDetails.start)
          : new Date(),
        end: isValidDate(new Date(eventDetails.end))
            ...
            <div>
              <label>
                ...
                <input
                  ...
                  name="start"
                  value={
                    isValidDate(new Date(event.start))
            ...
            <div>
              <label>
                ...
                <input
                  ...
                  name="end"
                  value={
                    isValidDate(new Date(event.end))
